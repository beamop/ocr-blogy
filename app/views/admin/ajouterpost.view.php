<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <form action="<?= HOST_NAME ?>admin/addpost" method="post">
      <div class="form-group">
        <label for="Titre du post">Titre du post</label>
        <input type="text" class="form-control" id="tpost" name="tpost" placeholder="Mon nouveau post!">
      </div>
      <div class="form-group">
        <label for="Contenu du post">Contenu du post</label>
        <tcontenu class="form-control" id="tcontenu" name="tcontenu" placeholder="Contenu du post"></tcontenu>
      </div>
